...
const About = () => {
  return (
    <section id='about' className='min-h-screen scroll-mt-20 bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto'>
            <div className='flex flex-col lg:flex-row gap-12 mb-20'>
                ...
                <p className='text-lg text-gray-600 mb-4'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus unde voluptatem libero pariatur quasi vero obcaecati vel iure nihil aut deleniti iusto quo nobis minima necessitatibus, quam, quae facilis optio?
                </p>
